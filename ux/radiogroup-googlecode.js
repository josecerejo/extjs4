// copied from: http://code.google.com/p/wsproject/source/browse/trunk/server/msweb/js/Ext.ux/Ext.ux.RadioGroup.js?spec=svn26&r=26
...
Ext.ux.RadioGroup = Ext.extend(Ext.form.Field,  {
	...
	setChecked:function(v){
        if(this.el && this.el.dom){
			var fire = false;
			if(v != this.checked&&!this.checked)fire=true;
			this.checked=v;
